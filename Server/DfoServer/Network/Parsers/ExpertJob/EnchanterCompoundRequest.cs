...
{
    internal static class EnchanterCompoundRequest
    {
        internal static bool TryParse(byte[] body, out EnchanterCompoundCommand command)
        {
            command = null;
            ...
            command = new EnchanterCompoundCommand
            {
