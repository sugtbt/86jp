...
namespace DfoServer
{
    internal class Program
    {
        ...
        private static readonly (string Arg, Func<int> Run)[] SelfTestRegistry =
        {
            ...
            ("--selftest-auction-protocol", SelfTests.AuctionProtocolSelfTest.Run),
            ("--selftest-auction-storage", SelfTests.AuctionStorageSelfTest.Run),
            ("--selftest-auction-application", SelfTests.AuctionApplicationSelfTest.Run),
